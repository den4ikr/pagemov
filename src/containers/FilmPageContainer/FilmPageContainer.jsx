...
import { addToFavourites } from "../../services/localStorage"
import { getIsFavorite } from "../../redux/actions/favorite-action"
...
const FilmPageContainer = (props) => {
    ...
    const addFavoriteFilm = () => {
        addToFavourites(filmPageData);
        dispatch(getIsFavorite(filmPageData.id))
    };
    return (
        <FilmPage filmPageData={filmPageData} recommendations={recommendations} genres={genres} addFavoriteFilm={addFavoriteFilm} isFavorite={isFavorite} />
    )
}
